<template>
  <el-select ref="selection" v-model="value2" placeholder="请选择" style="width:100%" @change="change" filterable :multiple="multiple" :disabled="disabled">
...
export default {
  ...
  created() {
    getUserList({ isDisable: 0 }).then(res => {
      this.list = res.data
      this.onload()
    })
  },
