<template>
  <div>
      ...
      <div class="basic-info-content">
        <div class="df-fw">
          ...
          <div class="grid-content1">
            发票类型：<span
              class="col-text"
              v-if="InvoiceTypeList[detailInfo.type]"
              >{{ InvoiceTypeList[detailInfo.type].label }}</span
            >
          </div>
          ...
          <div class="grid-content1">
            发票种类：<span
              class="col-text"
              v-if="InvoiceType[detailInfo.invoicingType]"
              >{{ InvoiceType[detailInfo.invoicingType].label }}</span
            >
          </div>
          <div class="grid-content1">
    ...
    <div
      class="basic-info-container"
      v-if="editType == 'show' && detailInfo.approvalStatus == 2"
    >
    ...
    <div class="btn-box">
      ...
      <el-button
        ...
        v-if="!disabled || showIssue == 1"
        >保存返回</el-button
      >
      <el-button type="primary" v-debounce="submitTo" v-if="!disabled"
        >提交</el-button
      >
      <el-button
        type="primary"
        v-debounce="approveClick"
    ...
    <ReturnDialog
      ...
      :approvalProcessVoList="detailInfo.approvalProcessVoList"
      :idData="idData"
      :type="2"
      :relationshipId="editId"
      @success="returnApproveSuccess"
      :showIssue="showIssue"
    />
  </div>
</template>
